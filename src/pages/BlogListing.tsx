...
const BLOGS = [
  { slug: "/blog/how-to-login-kheloo24ids", title: "How to Login Khelo24Bet Step by Step Guide 2026", desc: "Complete step by step guide on how to login kheloo24ids with username." },
  { slug: "/blog/how-to-use-kheloo24ids-online", title: "How to Use Khelo24Bet Online — Complete Guide", desc: "Learn how to use kheloo24ids online platform and start playing instantly." },
...
const BlogListing = () => {
  useSeo({
    title: "Blog — Khelo24Bet | Sports Gaming Tips & Guides",
    description: "Read the latest tips, guides and strategies for online sports gaming on Khelo24Bet. Cricket betting tips, Aviator strategies, login guides and more.",
    canonical: "/blog",
  ...
  return (
    <main>
      ...
      <section className="container py-12 md:py-20">
        ...
        <p className="text-muted-foreground max-w-2xl mb-10">Tips, strategies and step-by-step guides to help you win more on Khelo24Bet.</p>

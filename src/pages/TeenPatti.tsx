...
const TeenPatti = () => {
  useSeo({
    title: "Play Teen Patti Online on Khelo24Bet",
    description: "Enjoy Teen Patti online on Khelo24Bet - India's favourite card game.",
    ...
    <main>
      ...
      <section className="container py-12 md:py-20">
        <h1 className="text-3xl md:text-5xl font-black tracking-tight mb-4">
          Teen Patti on <span className="text-gradient-gold">Khelo24Bet</span>
        </h1>
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center mb-14">
          ...
          <div>
            ...
            <h3 className="font-bold mb-2 text-sm">Bet on Gameplay Interface with Khelo24Bet</h3>
        ...
        <div className="max-w-3xl">
          <h2 className="text-xl md:text-2xl font-bold mb-3">Play Teen Patti on Khelo24Bet</h2>
